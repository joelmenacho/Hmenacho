...
export default function Cart() {
  ...
  return (
    <div>
      <Head>
        <title>HM Compras online</title>
        <meta name="description" content="Seguimiento en tiempo real de tu compra" />
      ...
      <div className="p-3 max-w-7xl m-auto">
        ...
        <div>
            ...
            Lo último en tendencias en Tecnología, Electrohogar, Decoración y Muebles haciendo que tu hogar esté a la moda, con estilo y al mejor precio.. 
            </p>
                        ...
                        <div className="">
                            ...
                            <div className="bg-white p-4 px-3 pb-4 ease-in-out duration-300">
                              ...
                              <div className="absolute top-3 left-0 right-0 px-3 flex justify-between items-center gap-2 w-full">
                                  <button className="bg-white text-sky-600 text-xl h-10 w-10 flex justify-center items-center rounded-md font-normal active:scale-95" title="Decrease">
                                    <BiMinus />
                                  </button>
                                  <button className="bg-white text-sky-600 text-xl h-10 w-10 flex justify-center items-center rounded-md font-normal active:scale-95" title="Increase">
                                    <BiPlus />
                                  </button>
                              </div>
                            </div>
